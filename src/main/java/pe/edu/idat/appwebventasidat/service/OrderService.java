...
public class OrderService {
    ...
    public ResultadoResponse registrarVenta(OrderRequest order, List<OrderDetailRequest> orderDetailList){
        try {
            Order newOrder = new Order();
            newOrder.setRequieddate(order.getRequieddate());
            newOrder.setShippeddate(order.getShippeddate());
            newOrder.setOrderdate(order.getOrderdate());
            Customer newCustomer = new Customer();
            newCustomer.setCustomerid(order.getCustomerid());
            Employee newEmployee = new Employee();
            newEmployee.setEmployeeid(order.getEmployeeid());
            ...
            for (OrderDetailRequest orderDetailRequest : orderDetailList){
                ...
                OrderDetailId orderDetailId = new OrderDetailId(insertOrder.getOrderid(), orderDetailRequest.getProductid());
