...
public class DetalleUsuarioService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return autenticacionUsuario(usuario, obtenerListaRolesPorUsuarios(usuario.getRoles()));
    }
    private List<GrantedAuthority> obtenerListaRolesPorUsuarios(Set<Rol> listRoles){
